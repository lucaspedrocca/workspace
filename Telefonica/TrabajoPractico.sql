...
/*La unica diferencia que se puede observar entre la consulta 11 y 12, es una fila que tiene el mismo valor tanto en tipo y edición, que en la consulta 12 no es tomada en cuenta por consecuencia de haber declarado estos valores como DISTINCT.*/
