...
# Ruta para mostrar una página con datos de la base de datos
@app.route('/')
def index():
    query = 'SELECT * FROM logs LIMIT 10'  # Ajusta el límite según tus necesidades
    results = execute_sql_query(query)
    return render_template('index.html', logs=results)
